    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Suman</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Your's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>A chotu sa gift for my fresh adult girly girl💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Jyoti 💖</h2>
          <p className="final-subtitle"> Chal rone ki jarurat nahi hai..mei hu he itni achi...thankyou k badle YSL ki heels dedio bas..hehheheheh!!! ✨</p>
        </section>
      </div>
